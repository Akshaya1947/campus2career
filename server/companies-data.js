// companies-data.js - Complete Company Profiles for Campus2Career MongoDB
// Profiles: TCS, Cognizant, Accenture, Wipro, and Soliton
...
WHERE salary < (SELECT MAX(salary) FROM Employee);`,
  ...
  return maxSoFar;
        ...
        explanation: 'Kadane’s algorithm runs in O(N) time and O(1) auxiliary space.',
      },
    ],
  },
  {
  ...
  return -1;
        ...
        explanation: 'Uses a hashmap for frequency counting with O(N) time and O(1) space.',
      },
    ],
  },
  {
